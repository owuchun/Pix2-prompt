...
**Pix2-prompt** is a versatile visual prompt generation Skill. It combines the massive style library of **Nano Banana Pro** with **cinematic storyboard logic** to provide you with professional AI visual creation instructions.
...
Pix2-prompt has you covered.has you covered.
...
Pix2-prompt uses an intelligent search strategy that **saves 97% of Tokens** compared to traditional methods.
...
1.  Place the `Pix2-prompt` folder into your skills directory:
...
Below are examples of image and video prompts generated by Pix2-prompt for a specific style (Dopamine Girl).
